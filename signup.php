...
<body>
    ...
    <form class="home" action="" method="POST">
        ...
        <div>
            ...
            <input type="text" class="form-control" name="login" id="login" placeholder="pescobar@gmail.com" required>
        </div>
        <div>
            <label for="password" class="form-label">Mot de passe</label>
            <input type="password" class="form-control" name="password" id="password" placeholder="gustavo123" required>
        </div>
        <button type="submit" class="btn">Submit</button>
    </form>
    <a class="home" href="login.php">login here</a>
